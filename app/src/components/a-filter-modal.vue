    ...
    <ion-page class="overlay">
        <ion-content :fullscreen="true">
            ...
            <ion-item v-for="sel in labelsDate" :key="sel">
                ...
                <ion-select v-model="sel.value" interface="popover" justify="space-between"
                            :placeholder="optionsDate[0].text">
...
<script lang="ts">
import {
    placeholderMembers, taskFilterMember, taskFilterImportance, TaskFilter,
...
export default defineComponent({
    ...
    data() {
        ...
        for (const o of placeholderMembers) members.push({name: o, value: true});
        const statuses: taskFilterStatus[] = [];
        for (const o of TaskStatuses) statuses.push({status: o, value: true});
        return {
            members,
            statuses,
            modalFilter: {} as TaskFilter,
            close,
            optionsDate: [
                {id: 'any', text: "Any"},
